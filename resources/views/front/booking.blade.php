        ...
        <div class="booking-wrap">
            ...
            <form class="row flex-row" method="POST" id="bookingForm" action="{{route('enquirysubmit')}}" >
                ...
                <div class="form-group col-xs-12 col-md-12">
                    ...
                    <input type="text" class="form-control" name="mobilenos" id="mobilenos" placeholder="phone number" required>
                    <span class="form_error" id="invalid_mobilenos" style="display:none">Mobile Number is required</span>
                </div>
                <div class="form-group col-xs-12 col-md-12">
                    <label>Alternate Mobile Number</label>
                    <input type="text" class="form-control" name="alt_mobilenos" id="alt_mobilenos" placeholder="alternate phone number">
                </div>
                <div class="form-group col-xs-12 col-md-12">
                ...
                <div class="form-group col-xs-12 col-md-12">
                    ...
                    <input type="text" class="form-control" name="traveldate" required placeholder="Travel Date and Time" readonly id="traveldate">
                    <input type="hidden" hidden readonly name="traveldatetime" id="traveldatetime">
                    <span class="form_error" id="invalid_traveldate" style="display:none">Travel Date Time is required</span>
                </div>

                <div class="form-group col-xs-12 col-md-12">
                    <label>Pickup/ Destination Address</label>
                    <input type="text" name="pickupaddress" id="pickupaddress" class="form-control" placeholder="pickup or destination address" required>
                    <span class="form_error" id="invalid_pickupaddress" style="display:none">Pickup/Destination is required</span>
                </div>
                ...
                <div class="form-group col-xs-12 col-md-12">
                    ...
                    <input type="text" name="flightinfo" id="flightinfo" class="form-control" placeholder="flight number or cruise name">
                    <span class="form_error" id="invalid_flightinfo" style="display:none">Flight / Cruise Information is required</span>
                </div>
                ...
                <div class="form-group col-xs-12">
                    <button type="button" class="submitbtn btn btn-danger btn-lg">Send Enquiry</button>
                </div>
            </form>
        </div>
    </div>
