            ...
            <div class="mid-nav">
              ...
              <ul class="mobile-sub wsmenu-list">
                ...
                <li>
                    ...
                    <a class="@if( $activevar == 'airport' ||  $activevar == 'cruise' ||  $activevar == 'wedding' || $activevar == 'hensparty' || $activevar == 'nighthire' || $activevar == 'privatehire' ) active @endif">Services <span class="arrow"></span></a>

                    <ul class="wsmenu-submenu">

                      <li><a href="/airport"><i class="fa fa-angle-right"></i>Door-to-door airport hire </a></li>
                      ...
                      <li><a href="/nighthire"><i class="fa fa-angle-right"></i>Sydney night party hire</a></li>

                      <li><a href="/privatehire"><i class="fa fa-angle-right"></i>Private or corporate function hire</a></li>
      ...
      <div class="container">
        ...
        <div class="row flex-row">
          ...
          <div class="col-md-4 col-xs-12">
            ...
            <p class="contact-link"><a href="#"> <i class="fa fa-mobile-phone"></i> <span>1800 865 845</span></a></p>
